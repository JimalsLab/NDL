class StringDot {
	...
	copy() {
		// var randomCorner = p.createVector(Math.round(Math.random(0,1))*p.width, Math.round(Math.random(0,1))*p.height);
		return new StringDot(this.radius, this.target.copy(), /*randomCorner */ this.pos.copy(), this.acc.copy(), this.vel.copy());
	}
	behaviors() {
